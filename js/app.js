...
var answer5 = prompt('Does Nicholas speak French?').toLowerCase();
if(answer5 === 'y' || answer5 === 'yes') {
alert('Incorrect, however, Nicholas has ');
} else{
alert('Correct, Nicholas can read a d write a little Mandarin but does not know any French');
}


// Does Nicholas Have a dog</li>
// <li>Is Nicholas from Washington</li>
// <li>Did Nicholas work for law enforcement?</li>
// <li>Does Nicholas speak French?</li>
// <li>Did Nicholas climb K2</li>
//
